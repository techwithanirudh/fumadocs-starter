...
> **Note:** The API key must start with `sk-` as validated by the environment schema.

## Application Configuration

The logic for AI search is pre-configured in the `src/components/fumadocs/ai` directory. You can explore or modify the implementation there to suit your needs.
